...
const { listOrders, getOrder, updateOrderStatus, verifyPickup, verifyPayment, refundOrder, getOrderStats } = require('../controller/orderController');
...
router.patch('/:id/verify-payment', isAdmin, hasRole('orders:write'), verifyPayment);
