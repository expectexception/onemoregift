...
export default function SearchableSelect({ value, onChange, options, placeholder, disabled, className, usePortal = true }) {
    ...
    const dropdownContent = (
        <div
            className="bg-[#0a0a0a]/95 backdrop-blur-md border border-white/10 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] overflow-hidden z-[9999]"
            style={usePortal ? {
                position: "absolute",
                top: `${coords.top}px`,
                left: `${coords.left}px`,
