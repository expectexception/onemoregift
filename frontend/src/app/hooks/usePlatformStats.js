...
const normalizeStats = (data = {}) => ({
    ...
    upcomingGiveaways: Number(data.upcomingGiveaways || 0),
    completedGiveaways: Number(data.completedGiveaways || 0),
    totalWinners: Number(data.totalWinners || 0),
    giveawayWinners: Number(data.giveawayWinners ?? data.totalWinners ?? 0),
    giftsDelivered: Number(data.giftsDelivered || 0),
    momentsShared: Number(data.momentsShared || 0),
